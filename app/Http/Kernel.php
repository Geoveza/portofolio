...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Http\Middleware\BlockBadUserAgents::class,
        ...
        \App\Http\Middleware\ProductionSecurityCheck::class,
    ];
    ...
    protected $middlewareAliases = [
        ...
        'block.bad.agents' => \App\Http\Middleware\BlockBadUserAgents::class,
    ];
}